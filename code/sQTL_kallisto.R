...
isopos_c = fread("/path/to/eQTL/kallisto/geneInfo.txt") %>% 
  ...
  as.data.frame()
psi_c <- fread(paste0("/path/to/sQTL/kallisto/quantile-rank-normalized_transcript_ratio.txt")) %>%
  dplyr::rename(gid = V1) %>%
  as.data.frame()
peer_factors <- fread(paste0("/path/to/sQTL/kallisto/PEERfactors.txt")) %>%
  as.data.frame()
  ...
  tryCatch({
    ...
    if ( nrow(expr2) > 0 &&
      ...
      me$cis$eqtls %>%
        ...
        write.table(., 
                    paste0("/path/to/DICE/QTL/result/splicing_peer/chr",chr,"_in_",stim,"_kallisto.txt"),
  ...
  tryCatch({
    ...
    if ( nrow(expr2) > 0 &&
      ...
      me$cis$eqtls %>%
        ...
        dplyr::arrange(pvalue) %>%
        write.table(., 
                    paste0("/path/to/EGA/QTL/result/splicing_peer/chr",chr,"_in_",stimulus,"_kallisto.txt"),
                    sep = "\t",quote=FALSE, row.names = FALSE)
  ...
  tryCatch({
    ...
    if ( nrow(expr2) > 0 &&
      ...
      me$cis$eqtls %>%
        ...
        dplyr::arrange(pvalue) %>%
        write.table(., 
                    paste0("/path/to/ImmVar/QTL/result/splicing_peer/chr",chr,"_in_",stim,"_kallisto.txt"),
                    sep = "\t",quote=FALSE, row.names = FALSE)
  ...
  tryCatch({
    ...
    if ( nrow(expr2) > 0 &&
      ...
      me$cis$eqtls %>%
        ...
        dplyr::arrange(pvalue) %>%
        write.table(., 
                    paste0("/path/to/GEUV/QTL/result/splicing_peer/chr",chr,"_in_",stim,"_kallisto.txt"),
                    sep = "\t",quote=FALSE, row.names = FALSE)
